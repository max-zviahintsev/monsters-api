...
async function deleteMonsterHandler(
  req: FastifyRequest<{ Params: MonstersParams }>,
  reply: FastifyReply,
) {
  const id = Number(req.params.id)
  if (isNaN(id)) {
...
export { getAllMonstersHandler, getMonsterByIdHandler, addMonsterHandler, deleteMonsterHandler }
